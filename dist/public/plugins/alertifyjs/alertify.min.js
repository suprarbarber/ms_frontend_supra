...
!function (a) {
  ...
  function j(a, b) {
    if (a.elements) {
      ...
      c.parentNode.removeChild(c), delete a.elements, a.settings = i(a.__settings), a.__init = b, delete a.__internal;
    }
  }
  function k(a, b) {
    return function () {
  ...
  function n() {
    ...
    function c(b, c, e, f) {
      ...
      }), e || (g.dialog = a(new g.factory(), x)), d[b] = g;
    }
    var d = {};
    return {
      defaults: q,
  ...
  var o = ":not(:disabled):not(.ajs-reset)",
    ...
    q = {
      ...
      transition: "pulse",
      transitionOff: !1,
      tabbable: ["button", "[href]", "input", "select", "textarea", '[tabindex]:not([tabindex^="-"])' + o].join(o + ","),
      notifier: {
        delay: 5,
  ...
  var u = function u(a, b, c, d, e) {
      a.addEventListener(b, c, s ? {
        capture: d,
        passive: e
      } : !0 === d);
    },
    v = function v(a, b, c, d, e) {
      a.removeEventListener(b, c, s ? {
        capture: d,
        passive: e
      } : !0 === d);
    },
    ...
    x = function () {
      function n(a) {
        if (!a.__internal) {
          z.defaults.hooks.preinit(a), delete a.__init, a.__settings || (a.__settings = i(a.settings));
          var c;
          "function" == typeof a.setup ? (c = a.setup(), c.options = c.options || {}, c.focus = c.focus || {}) : c = {
            ...
            options: {}
          }, "object" != (0, _typeof2["default"])(a.hooks) && (a.hooks = {});
          var d = [];
          ...
          a.elements = l, j.resetHandler = k(a, $), j.beginMoveHandler = k(a, fa), j.beginResizeHandler = k(a, la), j.bringToFrontHandler = k(a, E), j.modalClickHandler = k(a, U), j.buttonsClickHandler = k(a, W), j.commandsClickHandler = k(a, I), j.transitionInHandler = k(a, ba), j.transitionOutHandler = k(a, ca);
          for (var p in j.options) void 0 !== c.options[p] ? a.set(p, c.options[p]) : z.defaults.hasOwnProperty(p) ? a.set(p, z.defaults[p]) : "title" === p && a.set(p, z.defaults.glossary[p]);
          "function" == typeof a.build && a.build(), z.defaults.hooks.postinit(a);
        }
      ...
      function t() {
        ...
        0 === a && document.body.className.indexOf(Ia.noOverflow) >= 0 ? (c(document.body, Ia.noOverflow), x(!1)) : a > 0 && document.body.className.indexOf(Ia.noOverflow) < 0 && (x(!0), b(document.body, Ia.noOverflow));
      }
      function x(d) {
        z.defaults.preventBodyShift && (d && document.documentElement.scrollHeight > document.documentElement.clientHeight ? (Ka = Ca, Ja = a.getComputedStyle(document.body).top, b(document.body, Ia.fixed), document.body.style.top = -Ca + "px") : d || (Ca = Ka, document.body.style.top = Ja, c(document.body, Ia.fixed), s()));
      }
      function y(a, d, e) {
        h(e) && c(a.elements.root, Ia.prefix + e), b(a.elements.root, Ia.prefix + d), Ea = a.elements.root.offsetWidth;
      }
      function A(a) {
        a.get("transitionOff") ? b(a.elements.root, Ia.noTransition) : c(a.elements.root, Ia.noTransition);
      }
      function B(a) {
        a.get("modal") ? (c(a.elements.root, Ia.modeless), a.isOpen() && (ua(a), Q(a), t())) : (b(a.elements.root, Ia.modeless), a.isOpen() && (ta(a), Q(a), t()));
      }
      function C(a) {
        a.get("basic") ? b(a.elements.root, Ia.basic) : c(a.elements.root, Ia.basic);
      }
      function D(a) {
        a.get("frameless") ? b(a.elements.root, Ia.frameless) : c(a.elements.root, Ia.frameless);
      }
      function E(a, b) {
        for (var c = r.indexOf(b), d = c + 1; d < r.length; d += 1) if (r[d].isModal()) return;
        return document.body.lastChild !== b.elements.root && (document.body.appendChild(b.elements.root), r.splice(r.indexOf(b), 1), r.push(b), Z(b)), !1;
      }
      function F(a, d, e, f) {
        switch (d) {
          case "title":
          ...
          case "resizable":
            ...
            break;
          case "padding":
            f ? c(a.elements.root, Ia.noPadding) : a.elements.root.className.indexOf(Ia.noPadding) < 0 && b(a.elements.root, Ia.noPadding);
            break;
          case "overflow":
            f ? c(a.elements.root, Ia.noOverflow) : a.elements.root.className.indexOf(Ia.noOverflow) < 0 && b(a.elements.root, Ia.noOverflow);
            break;
          case "transition":
            y(a, f, e);
            break;
      ...
      function G(a, b, c, d, e) {
        ...
        if (void 0 === e && "string" == typeof d) f.op = "get", b.hasOwnProperty(d) ? (f.found = !0, f.value = b[d]) : (f.found = !1, f.value = void 0);else {
          var g;
          if (f.op = "set", "object" == (0, _typeof2["default"])(d)) {
            var h = d;
      ...
      function L(a) {
        m("onmaximize", a), b(a.elements.root, Ia.maximized), a.isOpen() && t(), m("onmaximized", a);
      }
      function M(a) {
        m("onrestore", a), c(a.elements.root, Ia.maximized), a.isOpen() && t(), m("onrestored", a);
      }
      function N(a) {
        a.get("pinnable") ? b(a.elements.root, Ia.pinnable) : c(a.elements.root, Ia.pinnable);
      }
      function O(a) {
        var b = f();
      ...
      function R(a) {
        a.get("pinned") ? (c(a.elements.root, Ia.unpinned), a.isOpen() && P(a)) : (b(a.elements.root, Ia.unpinned), a.isOpen() && !a.isModal() && O(a));
      }
      function S(a) {
        a.get("maximizable") ? b(a.elements.root, Ia.maximizable) : c(a.elements.root, Ia.maximizable);
      }
      function T(a) {
        a.get("closable") ? (b(a.elements.root, Ia.closable), za(a)) : (c(a.elements.root, Ia.closable), Aa(a));
      }
      function U(a, b) {
      ...
      function V(a, b) {
        if (Date.now() - Na > 200 && (Na = Date.now())) for (var c = 0; c < a.__internal.buttons.length; c += 1) {
      ...
      function X(a) {
        ...
        var b = r[r.length - 1],
          c = a.keyCode;
        return 0 === b.__internal.buttons.length && c === p.ESC && !0 === b.get("closable") ? (H(b), !1) : Da.indexOf(c) > -1 ? (V(b, function (a) {
          return a.key === c;
        }), !1) : void 0;
      }
      function Y(a) {
        ...
        } else if (c < p.F12 + 1 && c > p.F1 - 1 && Da.indexOf(c) > -1) return a.preventDefault(), a.stopPropagation(), V(b, function (a) {
          return a.key === c;
        }), !1;
      }
      function Z(a, b) {
        if (b) b.focus();else {
          var c = a.__internal.focus,
            d = c.element;
          switch ((0, _typeof2["default"])(c.element)) {
            case "number":
      ...
      function $(a, b) {
        if (!b) for (var c = r.length - 1; c > -1; c -= 1) if (r[c].isModal()) {
          b = r[c];
          break;
        }
        if (b && b.isModal()) {
          ...
          i === f || i === document.body ? d = e : i === e && g === f ? d = _(b) : i === e && h && (d = _(b, !0)), Z(b, d);
        }
      }
      function _(a, b) {
      ...
      function ba(a, b) {
        clearTimeout(b.__internal.timerIn), Z(b), Oa = !1, m("onfocus", b), v(b.elements.dialog, w.type, b.__internal.transitionInHandler), c(b.elements.root, Ia.animationIn);
      }
      function ca(a, b) {
        clearTimeout(b.__internal.timerOut), v(b.elements.dialog, w.type, b.__internal.transitionOutHandler), ia(b), oa(b), b.isMaximized() && !b.get("startMaximized") && M(b), "function" == typeof b.__internal.destroy && b.__internal.destroy.apply(b);
      }
      function da(a, b) {
        var c = a[Sa] - Qa,
          d = a[Ta] - Ra;
        Va && (d -= document.body.scrollTop), b.style.left = c + "px", b.style.top = d + "px";
      }
      function ea(a, b) {
        var c = a[Sa] - Qa,
          d = a[Ta] - Ra;
        Va && (d -= document.body.scrollTop), b.style.left = Math.min(Ua.maxLeft, Math.max(Ua.minLeft, c)) + "px", b.style.top = Va ? Math.min(Ua.maxTop, Math.max(Ua.minTop, d)) + "px" : Math.max(Ua.minTop, d) + "px";
      }
      function fa(a, c) {
        if (null === Xa && !c.isMaximized() && c.get("movable")) {
          var d,
            e = 0,
            f = 0;
          if ("touchstart" === a.type ? (a.preventDefault(), d = a.targetTouches[0], Sa = "clientX", Ta = "clientY") : 0 === a.button && (d = a), d) {
            var g = c.elements.dialog;
            if (b(g, Ia.capture), g.style.left && (e = parseInt(g.style.left, 10)), g.style.top && (f = parseInt(g.style.top, 10)), Qa = d[Sa] - e, Ra = d[Ta] - f, c.isModal() ? Ra += c.elements.modal.scrollTop : c.isPinned() && (Ra -= document.body.scrollTop), c.get("moveBounded")) {
              var h = g,
                i = -e,
                j = -f;
              do {
            ...
            return m("onmove", c), Va = !c.isModal() && c.isPinned(), Pa = c, Wa(d, g), b(document.body, Ia.noSelection), !1;
          }
        }
      }
      function ga(a) {
        if (Pa) {
          var b;
          "touchmove" === a.type ? (a.preventDefault(), b = a.targetTouches[0]) : 0 === a.button && (b = a), b && Wa(b, Pa.elements.dialog);
        }
      }
      function ha() {
        if (Pa) {
          var a = Pa;
          Pa = Ua = null, c(document.body, Ia.noSelection), c(a.elements.dialog, Ia.capture), m("onmoved", a);
        }
      }
      function ia(a) {
        Pa = null;
      ...
      function ja(a) {
        a.get("movable") ? (b(a.elements.root, Ia.movable), a.isOpen() && va(a)) : (ia(a), c(a.elements.root, Ia.movable), a.isOpen() && wa(a));
      }
      function ka(a, b, c) {
        var e = b,
          f = 0,
        ...
        var j = d();
        if (j && (h = document.body.offsetWidth - h, isNaN(Ya) || (f = document.body.offsetWidth - f - b.offsetWidth)), b.style.height = i - g + _a + "px", b.style.width = h - f + _a + "px", !isNaN(Ya)) {
          var k = .5 * Math.abs(b.offsetWidth - Za);
          j && (k *= -1), b.offsetWidth > Za ? b.style.left = Ya + k + "px" : b.offsetWidth >= $a && (b.style.left = Ya - k + "px");
        }
      }
      function la(a, c) {
        if (!c.isMaximized()) {
          ...
          if ("touchstart" === a.type ? (a.preventDefault(), d = a.targetTouches[0]) : 0 === a.button && (d = a), d) {
            m("onresize", c), Xa = c, _a = c.elements.resizeHandle.offsetHeight / 2;
            var e = c.elements.dialog;
            return b(e, Ia.capture), Ya = parseInt(e.style.left, 10), e.style.height = e.offsetHeight + "px", e.style.minHeight = c.elements.header.offsetHeight + c.elements.footer.offsetHeight + "px", e.style.width = (Za = e.offsetWidth) + "px", "none" !== e.style.maxWidth && (e.style.minWidth = ($a = e.offsetWidth) + "px"), e.style.maxWidth = "none", b(document.body, Ia.noSelection), !1;
          }
        }
      }
      function ma(a) {
        if (Xa) {
          var b;
          "touchmove" === a.type ? (a.preventDefault(), b = a.targetTouches[0]) : 0 === a.button && (b = a), b && ka(b, Xa.elements.dialog, !Xa.get("modal") && !Xa.get("pinned"));
        }
      }
      function na() {
        if (Xa) {
          var a = Xa;
          Xa = null, c(document.body, Ia.noSelection), c(a.elements.dialog, Ia.capture), La = !0, m("onresized", a);
        }
      }
      function oa(a) {
        Xa = null;
        var b = a.elements.dialog;
        "none" === b.style.maxWidth && (b.style.maxWidth = b.style.minWidth = b.style.width = b.style.height = b.style.minHeight = b.style.left = "", Ya = Number.Nan, Za = $a = _a = 0);
      }
      function pa(a) {
        a.get("resizable") ? (b(a.elements.root, Ia.resizable), a.isOpen() && xa(a)) : (oa(a), c(a.elements.root, Ia.resizable), a.isOpen() && ya(a));
      }
      function qa() {
      ...
      function wa(a) {
        v(a.elements.header, "mousedown", a.__internal.beginMoveHandler), v(a.elements.header, "touchstart", a.__internal.beginMoveHandler, !1, !1);
      }
      function xa(a) {
      ...
      function ya(a) {
        v(a.elements.resizeHandle, "mousedown", a.__internal.beginResizeHandler), v(a.elements.resizeHandle, "touchstart", a.__internal.beginResizeHandler, !1, !1);
      }
      function za(a) {
      ...
      var Ba,
        ...
        Ea = null,
        Fa = !1,
        Ga = a.navigator.userAgent.indexOf("Safari") > -1 && a.navigator.userAgent.indexOf("Chrome") < 0,
        Ha = {
      ...
      return {
        ...
        moveTo: function moveTo(a, b) {
          if (!isNaN(a) && !isNaN(b)) {
            ...
            var h = a - f,
              i = b - g;
            d() && (h *= -1), c.style.left = h + "px", c.style.top = i + "px", m("onmoved", this);
          }
          return this;
        },
        resizeTo: function resizeTo(a, b) {
          ...
          if (!isNaN(c) && !isNaN(d) && !0 === this.get("resizable")) {
            m("onresize", this), ("" + a).match(e) && (c = c / 100 * document.documentElement.clientWidth), ("" + b).match(e) && (d = d / 100 * document.documentElement.clientHeight);
            var f = this.elements.dialog;
            "none" !== f.style.maxWidth && (f.style.minWidth = ($a = f.offsetWidth) + "px"), f.style.maxWidth = "none", f.style.minHeight = this.elements.header.offsetHeight + this.elements.footer.offsetHeight + "px", f.style.width = c + "px", f.style.height = d + "px", m("onresized", this);
          }
          return this;
        },
        setting: function setting(a, b) {
          var c = this,
            d = G(this, this.__internal.options, function (a, b, d) {
              F(c, a, b, d);
            }, a, b);
          if ("get" === d.op) return d.found ? d.value : void 0 !== this.settings ? G(this, this.settings, this.settingUpdated || function () {}, a, b).value : void 0;
          if ("set" === d.op) {
            if (d.items.length > 0) for (var e = this.settingUpdated || function () {}, f = 0; f < d.items.length; f += 1) {
              var g = d.items[f];
              g.found || void 0 === this.settings || G(this, this.settings, e, g.key, g.value);
            }
            return this;
          }
        },
        ...
        setHeader: function setHeader(b) {
          return h(b) ? (g(this.elements.header), this.elements.header.innerHTML = b) : b instanceof a.HTMLElement && this.elements.header.firstChild !== b && (g(this.elements.header), this.elements.header.appendChild(b)), this;
        },
        setContent: function setContent(b) {
          return h(b) ? (g(this.elements.content), this.elements.content.innerHTML = b) : b instanceof a.HTMLElement && this.elements.content.firstChild !== b && (g(this.elements.content), this.elements.content.appendChild(b)), this;
        },
        ...
        destroy: function destroy() {
          return this.__internal && (this.__internal.isOpen ? (this.__internal.destroy = function () {
            j(this, n);
          }, this.close()) : this.__internal.destroy || j(this, n)), this;
        }
      };
    }(),
    y = function () {
      function d(a) {
        if (!a.__internal) {
          ...
          ("transitionOff" in q.notifier ? q.notifier.transitionOff : q.transitionOff) && (p = o.base + " ajs-no-transition"), i(a);
        }
      ...
      function j(d, i) {
        ...
        function p(a) {
          ...
          }, a.__internal.clickHandler = k(a, j), a.__internal.transitionEndHandler = k(a, n)), a;
        }
        function q(a) {
        ...
        return p({
          ...
          dismiss: function dismiss(a) {
            return this.__internal.pushed && (q(this), "function" == typeof this.ondismiss && !1 === this.ondismiss.call(this) || (v(this.element, "click", this.__internal.clickHandler), void 0 !== this.element && this.element.parentNode === m && (this.__internal.transitionTimeout = setTimeout(this.__internal.transitionEndHandler, w.supported ? 1e3 : 100), c(this.element, o.visible), "function" == typeof this.callback && this.callback.call(this, a)), f(this))), this;
          },
          delay: function delay(a) {
            if (q(this), this.__internal.delay = void 0 === a || isNaN(+a) ? y.__internal.delay : +a, this.__internal.delay > 0) {
              var b = this;
          ...
          setContent: function setContent(c) {
            if (h(c) ? (g(this.element), this.element.innerHTML = c) : c instanceof a.HTMLElement && this.element.firstChild !== c && (g(this.element), this.element.appendChild(c)), this.__internal.closeButton) {
              var d = document.createElement("span");
              b(d, o.close), d.setAttribute("data-close", !0), this.element.appendChild(d);
            }
            return this;
          },
      ...
      return {
        ...
        create: function create(a, b) {
          ...
          return c.className = o.message + ("string" == typeof a && "" !== a ? " " + o.prefix + a : ""), j(c, b);
        },
  ...
  z.dialog("alert", function () {
    ...
    function b(b, d, e) {
      a(b), c.duration = e, c.index = d, c.text = b.__internal.buttons[d].element.innerHTML, c.timer = setInterval(k(b, c.task), 1e3), c.task(null, b);
    }
    var c = {
      timer: null,
      index: null,
    ...
    return {
      ...
      build: function build() {
        b.className = z.defaults.theme.input, b.setAttribute("type", "text"), b.value = this.get("value"), this.elements.content.appendChild(c), this.elements.content.appendChild(b);
      },
      prepare: function prepare() {},
      setMessage: function setMessage(b) {
        h(b) ? (g(c), c.innerHTML = b) : b instanceof a.HTMLElement && c.firstChild !== b && (g(c), c.appendChild(b));
      },
      settings: {
        message: void 0,
        labels: void 0,
  ...
  }), "object" == (typeof module === "undefined" ? "undefined" : (0, _typeof2["default"])(module)) && "object" == (0, _typeof2["default"])(module.exports) ? module.exports = z : "function" == typeof define && define.amd ? define([], function () {
    return z;
